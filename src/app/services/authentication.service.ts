...
export class AuthenticationService {
  ...
  constructor() {
    ...
    this.users.push({userId: UUID.UUID(), username: "ismail", password: "admin", roles: ["USER", "ADMIN"]});
  }
  ...
  public authenticateUser(appUser: AppUser): Observable<boolean> {
    ...
    localStorage.setItem("authUser", JSON.stringify({username: appUser.username, roles: appUser}));
    return of(true);
  }
